...
def test_example_workbooks(wb_dict: dict):
    ...
    with xw.App(visible=True, add_book=False) as app:
        ...
        if wb_object.additional_plots:

            expected['additional_plots'] = [plot['title'] for plot in wb_object.additional_plots]
        ...
        expected['sheets'] = [plot['title'] for plot in wb_object.additional_plots]
